...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_for_that_list(self):
        ...
        self.assertNotContains(response, 'otehr list item 2')
...
class NewListViewIntegratedTest(TestCase):
    ...
    def test_for_invalid_list_items_doesnt_save_but_shows_errors(self):
...
class NewListViewUnitTest(unittest.TestCase):
    ...
    def test_passes_POST_data_to_NewListForm(
            self, mock_redirect, mockNewLisForm
    ):
        new_list(self.request)
        mockNewLisForm.assert_called_once_with(data=self.request.POST)
